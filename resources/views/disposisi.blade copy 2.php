                    ...
                    <form name="frm_add" id="frm_add" action="/simpansurat" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="form-floating mb-3">
                                ...
                                <label for="suratLabel"><i class="ti ti-file-text"></i> No. Dokumen</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="perihal" id="perihalLabel" placeholder="Perihal" required />
                                <label for="perihalLabel"><i class="ti ti-file-text"></i> Nama Dokumen</label>
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="perihal" id="perihalLabel" placeholder="Perihal" required />
                                <label for="perihalLabel"><i class="ti ti-file-text"></i> Kategori</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="textarea" class="form-control" name="perihal" id="perihalLabel" placeholder="Deskripsi Dokumen" required />
                                <label for="perihalLabel"><i class="ti ti-file-text"></i> Deskripsi Dokumen</label>
                            </div>
                            <!-- <div class="form-floating mb-3">
